...
public struct Module: Sendable {
  ...
  public func endOf(_ b: BasicBlock) -> InsertionPoint {
    let h = LLVMCreateBuilderInContext(context)!
    LLVMPositionBuilderAtEnd(h, b.llvm.raw)
    return .init(h)
  }
  ...
  public mutating func insertAdd(
    ...
    switch overflow {
    case .ignore:
      return .init(LLVMBuildAdd(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    case .nuw:
      return .init(LLVMBuildNUWAdd(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    case .nsw:
      return .init(LLVMBuildNSWAdd(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    }
  }
  ...
  public mutating func insertSub(
    ...
    switch overflow {
    case .ignore:
      return .init(LLVMBuildSub(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    case .nuw:
      return .init(LLVMBuildNUWSub(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    case .nsw:
      return .init(LLVMBuildNSWSub(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    }
  }
  ...
  public mutating func insertMul(
    ...
    switch overflow {
    case .ignore:
      return .init(LLVMBuildMul(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    case .nuw:
      return .init(LLVMBuildNUWMul(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    case .nsw:
      return .init(LLVMBuildNSWMul(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    }
  }
  ...
  public mutating func insertUnsignedDiv(
    ...
    if exact {
      ...
      return .init(LLVMBuildUDiv(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    }
  }
  ...
  public mutating func insertSignedDiv(
    ...
    if exact {
      ...
      return .init(LLVMBuildSDiv(p.llvm, lhs.llvm.raw, rhs.llvm.raw, ""))
    }
  }
